"""Add cost columns to a Home Assistant statistics CSV.

This reads an existing cumulative daily file with columns:
...
Configure constants below instead of passing command line arguments.
"""
...
# Input CSV produced by convert_to_cumulative_daily.py
INPUT_FILE = "../daily/sp_services_import_daily.csv"
# Output CSV with added cost columns
OUTPUT_FILE = "sp_services_import_daily_with_cost.csv"
